function fid_in = jsx_setActiveLayer(fid_in, name, frombeginning)
% FUNCTION []=jsx_setActiveLayer( layername )
...
% Modified slightly by Alex Salmon on 2020.06.27 to write javascript to file; this version does not
% require an active connection to a running version of photoshop

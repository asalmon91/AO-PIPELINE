function dsin = get_fringe_periods(fringe_ffname, hv, dsin)
...
switch hv    
    ...
    case 'v'
        ...
        dsin.vertical_fringes_sinusoid_amplitude = sinusoid_amplitude;
        dsin.vertical_fringes_sinusoid_n_samples = sinusoid_n_samples;
        dsin.vertical_fringes_sinusoid_phase     = sinusoid_phase;
        dsin.vertical_fringes_sinusoid_offset    = sinusoid_offset;    

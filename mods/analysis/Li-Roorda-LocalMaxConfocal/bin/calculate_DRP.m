function [ density_per_annulus um_drp_sizes est_spacing] = calculate_DRP( coords , coord_bounds , um_per_pix, density_dc, reliability, tag )
...
title([tag(1:end-4) ' estimated spacing: ' num2str(est_spacing)]);
hold off;
